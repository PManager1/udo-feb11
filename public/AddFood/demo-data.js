  ...
  modifier_groups: [
    {
      ...
      required: true,
      options: [
        { id: 'opt_fries', name: 'French Fries', extra_price: 0.00, available: true },
        { id: 'opt_sweet_potato', name: 'Sweet Potato Fries', extra_price: 1.50, available: true },
        { id: 'opt_onion_rings', name: 'Onion Rings', extra_price: 2.00, available: true },
        { id: 'opt_coleslaw', name: 'Coleslaw', extra_price: 1.00, available: true }
      ]
    },
    {
      id: 'group_toppings',
      ...
      required: false,
      options: [
        { id: 'opt_cheese', name: 'Extra Cheese', extra_price: 1.50, available: true },
        { id: 'opt_bacon', name: 'Crispy Bacon', extra_price: 2.00, available: true },
        { id: 'opt_jalapenos', name: 'Jalapeños', extra_price: 0.75, available: true },
        { id: 'opt_avocado', name: 'Fresh Avocado', extra_price: 2.50, available: false }, // Example of 86ed option
        { id: 'opt_eggs', name: 'Fried Egg', extra_price: 1.75, available: true }
      ]
    },
    {
      ...
      required: false,
      options: [
        { id: 'opt_ketchup', name: 'Ketchup', extra_price: 0.00, available: true },
        { id: 'opt_mustard', name: 'Mustard', extra_price: 0.00, available: true },
        { id: 'opt_bbq', name: 'BBQ Sauce', extra_price: 0.50, available: true },
        { id: 'opt_ranch', name: 'Ranch', extra_price: 0.50, available: true },
        { id: 'opt_honey_mustard', name: 'Honey Mustard', extra_price: 0.50, available: true }
      ]
    },
    {
      ...
      required: true,
      options: [
        { id: 'opt_small', name: 'Small (16oz)', extra_price: 0.00, available: true },
        { id: 'opt_medium', name: 'Medium (20oz)', extra_price: 0.50, available: true },
        { id: 'opt_large', name: 'Large (24oz)', extra_price: 1.00, available: true }
      ]
    }
  ],
